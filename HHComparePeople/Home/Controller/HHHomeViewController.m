...
@interface HHHomeViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,BackData,CLLocationManagerDelegate>
...
//    NSLog(@"nndhflahks%@",self.celldata);
    ...
    if (status == kCLAuthorizationStatusNotDetermined) {
        ...
        self.locationMana.delegate = self;
        
        [self.locationMana startUpdatingLocation];
    }else{
        NSLog(@"授权失败");
    }
